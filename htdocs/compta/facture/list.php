...
$search_email = GETPOST('search_email', 'alpha'); // MMI Hack
...
$sql .= ' s.note_private soc_note_private,'; // MMI
...
if ($resql) {
	...
	if ($num > 0) {
		...
		while ($i < $imaxinloop) {
			...
			$companystatic->note_private = $obj->soc_note_private; // MMI : get soc private note
