...
$search_email = GETPOST('search_email', 'alpha'); // MMI
...
while ($i < $imaxinloop) {
	...
	$companystatic->email = $obj->email; // MMI Hack
	$companystatic->note_private = $obj->soc_note_private; // MMI Hack : get soc private note
