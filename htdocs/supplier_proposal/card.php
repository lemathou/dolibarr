...
$hideref = (GETPOST('hideref', 'int') ? GETPOST('hideref', 'int') : (getDolGlobalString('MAIN_GENERATE_DOCUMENTS_HIDE_REF') || getDolGlobalString('MAIN_GENERATE_SUPPLIER_PROPOSAL_HIDE_REF') ? 1 : 0));
